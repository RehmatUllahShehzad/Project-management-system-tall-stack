<x-slot name="header">
    <div class="flex w-full justify-between items-center">
        ...
        <a class="justify-end"
            href="{{ route('design.feedback', [$design->project->id, $design->id, $design->latestRevision->id]) }}">
            <x-buttons.primary label="Return to Design Feedbacks" />
        </a>
    </div>
</x-slot>
...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-12">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <x-forms.form method="post" action="submit" title="Create Revision" submit-text="create Revision">
