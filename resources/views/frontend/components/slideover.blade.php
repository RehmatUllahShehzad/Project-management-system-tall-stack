<div class="fixed inset-0 z-[100]" aria-labelledby="slide-over-title" role="dialog" aria-modal="true"
    x-data="{
    ...
    @showslideover.window.stop="show = true">
    <div class="absolute inset-0">
        <div x-show="show" class="absolute inset-0 transition-opacity bg-gray-500 bg-opacity-75" aria-hidden="true"
