 ...
 */
			onAdd: function() {
				...
				var elem = $(document.createElement('div')).addClass("marker").append($('<p class="marker-text cursor-pointer">'+(this.notes.length+1)+'</p>'))
																			  .prepend($('<img>',{src: '/lib/images/marker_black.webp', width:'100%'})).attr("title","");
				$(elem).tooltip({
					content: function() {
